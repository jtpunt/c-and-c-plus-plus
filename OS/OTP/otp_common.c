...
char* encryptMsg(char** keyTable, char* plaintext, char* key){
	...
	for(i = 0; i < length; i++){
		...
		int keyCharPos = getNumRepr(*keyTable[plaintext]); // get the position of the encrypted letter in the alphabet, same as above
